    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                let row = $("<div class='row pl-5'></div>");
                
                data.forEach(element => {
                    
                    let div_col = $("<div class='col-4'></div>");
                    let img = $("<img src='../includes/images/"+element.service_image+"' alt='service image' " + 
                        "class='border border-dark' height='300' width='300'>");
